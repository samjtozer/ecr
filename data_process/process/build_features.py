...
def load_mentions_from_json(mentions_json_file, docs, is_event, is_gold_mentions):
    ...
    for js_mention in js_mentions:
        ...
        #########################################################
        ## modified here: using untokenizer
        mention_str = untokenize(mention_str.split(" ")).lower()
        #########################################################
...
def find_head(x):
    ...
    #             return str(tok.text), str(tok.text.lower())
...
def main(args):
    ...
    with open(os.path.join(args.output_path,'train_data'), 'wb') as f:
